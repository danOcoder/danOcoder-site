...
// Original source: https://github.com/epicweb-dev/epic-stack/blob/main/other/build-icons.ts
...
async function generateSvgSprite({
  ...
  const symbols = await Promise.all(
    files.map(async (file) => {
      ...
      // Check the SVG itself for a stroke or fill
      ...
      // Query all elements in the SVG (paths, shapes, etc.) and check their fill and stroke
